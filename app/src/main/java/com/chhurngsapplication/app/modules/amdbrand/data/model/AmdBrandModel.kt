package com.chhurngsapplication.app.modules.amdbrand.`data`.model

import com.chhurngsapplication.app.R
import com.chhurngsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AmdBrandModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtPrice: String? = MyApp.getInstance().resources.getString(R.string.msg_amd_branding_20)
  ,
  /**
   * TODO Replace with dynamic value
   */
