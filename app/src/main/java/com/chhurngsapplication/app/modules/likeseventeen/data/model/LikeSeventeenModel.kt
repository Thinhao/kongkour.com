package com.chhurngsapplication.app.modules.likeseventeen.`data`.model

import com.chhurngsapplication.app.R
import com.chhurngsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class LikeSeventeenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguageTwo: String? = MyApp.getInstance().resources.getString(R.string.msg_hi_guys_this_i)
  ,
  /**
   * TODO Replace with dynamic value
   */
