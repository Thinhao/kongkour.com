package com.chhurngsapplication.app.modules.profilegalleryseven.`data`.model

import com.chhurngsapplication.app.R
import com.chhurngsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ProfileGallerySevenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtSixtySix: String? = MyApp.getInstance().resources.getString(R.string.lbl10)
